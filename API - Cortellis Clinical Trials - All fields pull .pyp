...
data = pd.read_excel(r'***********\NCT_Clinical.xlsx')
NCT = data["NCT"].tolist()
...
with concurrent.futures.ThreadPoolExecutor(max_workers = 500) as executor:
    future_to_origins = {executor.submit(process_nct, n, API_KEY, API_PWD): n for n in NCT[0:10500]}
...
df2.to_excel("*****/NCTFinal_Clinical.xlsx")
